...
/////xi e yi - inimigo posição. dance0 e dance1 - pés do inimigo
var xi = 320,
  yi = 500,
  vida = 12,
  inimigoON = 1,
  dance0, dance1 ////ROBOTIME, trocadilho horriveis
var xi0 = 40,
  yi0 = 40,
  dance, dance11, paint0, paint1 ////ROBOPONTO, 'paint0' e 'paint1' para inserir cor por proximidade
function preload() {
  soundFormats('ogg');
